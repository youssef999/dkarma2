...
class sendl extends StatefulWidget {

  final ud;
  final img;
  sendl(this.ud,this.img);

  @override
  _PostsScreenState createState() => _PostsScreenState();
}

class _PostsScreenState extends State<sendl> {
  String allposts;
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            Container(
                                              padding: EdgeInsets.all(10),
                                              child:RaisedButton(
                                                child:Text('Send the licences'),
                                                onPressed:(){
                                                   sendWhatsApp('+201097970465',widget.img);
                                                },
                                              )
                                             /* ListTile(
